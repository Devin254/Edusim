				...
				<div class="form-group">
					<?php
										                     ...
										                     { 
										                      ...
										                      echo '<tr class="odd gradeX"><td>EXAMINER IDENTIFICATION</td>';
										                      ...
										                      echo '<tr class="odd gradeX"><td>CONTACT MOBILE</td>';
										                      echo '<td>' . $row['contact'] . '</td></tr>';
										                    }
										                      echo '</thead> </table>';
										                      while ($row = mysqli_fetch_array($data_submit))
										                      {
										                      echo '<div class="text-warning" style="text-align: center;"><strong><h6><a href="edit_profile_examiner.php?person_id=' . $row['person_id'] . '&amp;first_name=' . $row['first_name'] . '&amp;other_names=' . $row['other_names'] . '&amp;identification=' . $row['identification'] . '&amp;email=' . $row['email'] . '&amp;grade_level=' . $row['grade_level'] . '&amp;contact=' . $row['contact'] .  '""><b class="text-success"><i class="glyphicon glyphicon-edit"></i> EDIT MY PROFILE</b></a></h6></strong></div></h6>';
										                      }
										                      mysqli_close($dbc);
										                  ?> 
				</div>	
