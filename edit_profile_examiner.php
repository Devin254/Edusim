				...
				<div class="panel-body">
				   <h6><form class="form-horizontal" role="form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                <input type="hidden"class="form-control" id="grade_level" name="grade_level" value="<?php if (!empty($grade_level)) echo $grade_level; ?>" />
                                </div>
                                <div class="form-group">
                                <label for="identification" class="col-sm-2 control-label">Examiner ID</label>
                                <div class="col-sm-6">
                               ...
                               <div class="form-group">
                                <label for="contact" class="col-sm-2 control-label">Mobile Contact</label>
                                <div class="col-sm-6">
