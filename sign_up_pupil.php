              ...
              <div class="box">
                  <div class="content-wrap">
                      <center style="padding-top: 10px"> 
                        <h5 style="font-weight:bold;color:#228B22"><i class="glyphicon glyphicon-user"></i> PUPIL SIGN UP</h5>
                        </center>
                      ...
                      <input type="hidden" class="form-control" id="type" name="type" value="PUPIL"/>
                      <input class="form-control" type="text" placeholder="First Name" name="first_name">
                      <input class="form-control" type="text" placeholder="Other Names" name="other_names">
                      <input class="form-control" type="text" placeholder="Identification" name="identification">
                      ...
                      <input class="form-control" type="text" placeholder="Parent's Contact" name="contact">
                  ...
                  <?php
                              ...
                              if (isset($_POST['submit'])) 
                              {
                                ...
                                $grade_level = mysqli_real_escape_string($tt, trim($_POST['grade_level']));
                                ...
                                if (!empty($username) && !empty($password1) && !empty($password2)) 
                                {
                                  ...
                                  if (mysqli_num_rows($data) == 0) 
                                  {
                                    if ($password1 == $password2) 
                                    {
                                       // The username is unique, so insert the data into the database
                                            $query = "INSERT INTO user (username, password, type, status) VALUES ('$username', SHA('$password1'), 'PUPIL','1')";
                                            ...
                                            $id_data = $row['user_id'];
                                            $query_other = "INSERT INTO `people` (`person_id`, `user_id`, `first_name`, `other_names`, `identification`, `grade_level`, `contact`, `email`) VALUES (NULL, '$id_data', '$first_name', '$other_names', '$identification', '$grade_level', '$contact', '$email')";
                                  ...
                                  echo '<br>
                                    <div class="alert alert-danger alert-dismissible">
                                                  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                                  <p style="font-size: 11px;"><strong><i class="glyphicon glyphicon-remove-circle"></i></strong></h6>
                                                  <strong>PLEASE PROVIDE ALL THE CORRECT DETAILS ABOVE</strong>
                                                  </p>
                                    </div>';
                                }
